...
/********************************************************************************/
		...
		.def("canBuild", &CyPlayer::canBuild, "bool (CyPlot* pPlot, int (BuildTypes) eBuild, bool bTestEra, bool bTestVisible)")
			...
			.def("canCreateCityLogisticsRoute", &CyPlayer::canCreateCityLogisticsRoute, "bool (int iSourceCityID, int iTargetCityID, int /*YieldTypes*/ eYieldType)")
			.def("isCityLogisticsRouteActive", &CyPlayer::isCityLogisticsRouteActive, "bool (int iSourceCityID, int iTargetCityID, int /*YieldTypes*/ eYieldType)")
			.def("getCityLogisticsRouteFlow", &CyPlayer::getCityLogisticsRouteFlow, "int (int iSourceCityID, int iTargetCityID, int /*YieldTypes*/ eYieldType, bool bActiveOnly)")
			.def("getCityLogisticsImport", &CyPlayer::getCityLogisticsImport, "int (int iCityID, int /*YieldTypes*/ eYieldType, bool bActiveOnly)")
			.def("getCityLogisticsExport", &CyPlayer::getCityLogisticsExport, "int (int iCityID, int /*YieldTypes*/ eYieldType, bool bActiveOnly)")
			.def("getCityLogisticsNet", &CyPlayer::getCityLogisticsNet, "int (int iCityID, int /*YieldTypes*/ eYieldType, bool bActiveOnly)")
